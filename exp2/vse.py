...
"""
plays an igt game with vse model
"""
...
def participantCalc(delta,alpha,phi,theta, v,explore,exploit, prob, c,reward,option,penalty):
    v_1= prospectUtility(option,reward,penalty, v,theta)
